...
const Footer = () => {
  ...
  // Drivers don't see the public footer
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-gray-300 mb-3 max-w-md">
              Discover the beauty of Bihar with our premium car rental services and expertly curated tour packages. 
              Your journey to explore Bihar's rich heritage starts here.
            </p>
          ...
          <div className="hidden md:block">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/car-rental" className="text-gray-300 hover:text-white transition-colors">
                  Car Rental
                </Link>
              </li>
              <li>
                <Link to="/tour-packages" className="text-gray-300 hover:text-white transition-colors">
                  Tour Packages
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">+91 87090 83341</p>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">info@nextdrivebihar.in</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-6 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2026 NextDrive Bihar. All rights reserved.
            </p>
